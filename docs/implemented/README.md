...
This directory stores architecture/implementation plans whose main scope has
already been implemented and validated. Active or future plans remain directly
under `docs/`.
