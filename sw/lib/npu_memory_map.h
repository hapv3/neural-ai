...
#define REG_CONV_INPUT_PTR   (NPU_CTRL_BASE + 0x400)
#define REG_CONV_OUTPUT_PTR  (NPU_CTRL_BASE + 0x404)
#define REG_CONV_ROWS        (NPU_CTRL_BASE + 0x408)
#define REG_CONV_OUTPUT_W    (NPU_CTRL_BASE + 0x40C)
#define REG_CONV_INPUT_H     (NPU_CTRL_BASE + 0x410)
#define REG_CONV_INPUT_W     (NPU_CTRL_BASE + 0x414)
#define REG_CONV_INPUT_C     (NPU_CTRL_BASE + 0x418)
#define REG_CONV_KERNEL      (NPU_CTRL_BASE + 0x41C)
#define REG_CONV_STRIDE      (NPU_CTRL_BASE + 0x420)
#define REG_CONV_PAD         (NPU_CTRL_BASE + 0x424)
#define REG_CONV_DILATION    (NPU_CTRL_BASE + 0x428)
#define REG_CONV_K_BASE      (NPU_CTRL_BASE + 0x42C)
#define REG_CONV_START       (NPU_CTRL_BASE + 0x430)
#define REG_CONV_DONE        (NPU_CTRL_BASE + 0x434)
#define REG_CONV_STATUS      (NPU_CTRL_BASE + 0x438)
#define REG_CONV_MODE        (NPU_CTRL_BASE + 0x43C)

#define REG_RQ_CTRL_EN  0x00000001u
#define REG_SYS_ACCUM_CTRL_EN 0x00000001u
#define REG_SYS_ACCUM_CTRL_IFM_STREAM_EN 0x00000002u
#define REG_CONV_START_EN 0x00000001u
#define REG_CONV_MODE_STREAM_EN 0x00000001u
