...
#define REG_SYS_OFM_ROW_STRIDE (NPU_CTRL_BASE + 0x450)
#define REG_SYS_OFM_TILE_COLS (NPU_CTRL_BASE + 0x454)
#define REG_SYS_PSUM_ROW_STRIDE (NPU_CTRL_BASE + 0x458)
#define REG_RQ_CTRL     (NPU_CTRL_BASE + 0x120)
#define REG_RQ_CMIN     (NPU_CTRL_BASE + 0x124)
#define REG_RQ_CMAX     (NPU_CTRL_BASE + 0x128)
#define REG_BINARY_CTRL (NPU_CTRL_BASE + 0x12C)
#define REG_BINARY_RHS_PTR (NPU_CTRL_BASE + 0x130)
#define REG_BINARY_RHS_ROW_STRIDE (NPU_CTRL_BASE + 0x134)
#define REG_BINARY_RHS_TILE_COLS (NPU_CTRL_BASE + 0x138)
#define REG_BINARY_LHS_MULT (NPU_CTRL_BASE + 0x13C)
#define REG_BINARY_LHS_SHIFT (NPU_CTRL_BASE + 0x140)
#define REG_BINARY_RHS_MULT (NPU_CTRL_BASE + 0x144)
#define REG_BINARY_RHS_SHIFT (NPU_CTRL_BASE + 0x148)
#define REG_BINARY_OUTPUT_MULT (NPU_CTRL_BASE + 0x14C)
#define REG_BINARY_OUTPUT_SHIFT (NPU_CTRL_BASE + 0x150)
#define REG_BINARY_ZERO_POINTS (NPU_CTRL_BASE + 0x154)
#define REG_BINARY_CLAMP (NPU_CTRL_BASE + 0x158)
#define REG_BINARY_DOUBLE_ROUND (NPU_CTRL_BASE + 0x15C)
...
#define REG_LB_PRECOMP0   (NPU_CTRL_BASE + 0x45C)
#define REG_LB_CHANNEL_OFFSET (NPU_CTRL_BASE + 0x460)
#define REG_LB_COALESCE_K_BYTES (NPU_CTRL_BASE + 0x464)

#define REG_RQ_CTRL_EN  0x00000001u
#define REG_BINARY_CTRL_EN 0x00000001u
#define REG_BINARY_CTRL_MODE_SHIFT 1u
#define REG_BINARY_MODE_ADD 0u
#define REG_BINARY_MODE_SUB 1u
#define REG_BINARY_MODE_MUL 2u
...
#define REG_LB_CTRL_C32_GROUP_STATIONARY 0x00000040u
#define REG_LB_CTRL_GENERIC_LINEAR_K32 0x00000080u
...
#define NPU_AFU_ADD_BIAS      (NPU_AFU_BASE + 0x418)
#define NPU_AFU_BINARY_OP             (NPU_AFU_BASE + 0x41C)
#define NPU_AFU_BINARY_LHS_MULTIPLIER (NPU_AFU_BASE + 0x420)
#define NPU_AFU_BINARY_LHS_SHIFT      (NPU_AFU_BASE + 0x424)
#define NPU_AFU_BINARY_RHS_MULTIPLIER (NPU_AFU_BASE + 0x428)
#define NPU_AFU_BINARY_RHS_SHIFT      (NPU_AFU_BASE + 0x42C)
#define NPU_AFU_BINARY_OUT_MULTIPLIER (NPU_AFU_BASE + 0x430)
#define NPU_AFU_BINARY_OUT_SHIFT      (NPU_AFU_BASE + 0x434)
#define NPU_AFU_BINARY_ZERO_POINTS    (NPU_AFU_BASE + 0x438)
#define NPU_AFU_BINARY_CLAMP          (NPU_AFU_BASE + 0x43C)
#define NPU_AFU_BINARY_DOUBLE_ROUND   (NPU_AFU_BASE + 0x440)
