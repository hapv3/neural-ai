...
module tb_npu_cluster (
    ...
    input  logic [npu_cluster_pkg::AXI_HOST_DATA_WIDTH-1:0] s_axi_wdata,
    input  logic [(npu_cluster_pkg::AXI_HOST_DATA_WIDTH/8)-1:0] s_axi_wstrb,
    ...
    output logic [npu_cluster_pkg::AXI_HOST_DATA_WIDTH-1:0] s_axi_rdata,
