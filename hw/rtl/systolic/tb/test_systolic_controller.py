...
async def systolic_controller_channel_linebuf_kgen_3x3_c32(dut):
    ...
    if not done_seen:
        dut._log.warning(
            ...
            dut.dut.i_conv_channel_linebuf_packer.i_spatial_scheduler.state_q.value,
            dut.dut.linebuf_done.value,
            dut.dut.linebuf_emitted_vectors.value,
            dut.dut.i_conv_channel_linebuf_packer.i_spatial_scheduler.ow_q.value,
            dut.dut.i_conv_channel_linebuf_packer.i_spatial_scheduler.kh_q.value,
            dut.dut.i_conv_channel_linebuf_packer.i_spatial_scheduler.kw_q.value,
