...
module tb_systolic_controller;
    ...
    logic                          obi_b_req_o;
    logic                          obi_b_gnt_i;
    logic [ADDR_WIDTH-1:0]         obi_b_addr_o;
    logic                          obi_b_we_o;
    logic [(DATA_WIDTH/8)-1:0]     obi_b_be_o;
    logic [DATA_WIDTH-1:0]         obi_b_wdata_o;
    logic                          obi_b_rvalid_i;
    logic [DATA_WIDTH-1:0]         obi_b_rdata_i;
    ...
    systolic_controller #(
        ...
        .obi_b_req_o           (obi_b_req_o),
        .obi_b_gnt_i           (obi_b_gnt_i),
        .obi_b_addr_o          (obi_b_addr_o),
        .obi_b_we_o            (obi_b_we_o),
        .obi_b_be_o            (obi_b_be_o),
        .obi_b_wdata_o         (obi_b_wdata_o),
        .obi_b_rvalid_i        (obi_b_rvalid_i),
        .obi_b_rdata_i         (obi_b_rdata_i),
    ...
    assign obi_b_gnt_i = obi_b_req_o;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            obi_b_rvalid_i <= obi_b_req_o && obi_b_gnt_i && !obi_b_we_o;
            obi_b_rdata_i <= tcdm_mem[obi_b_addr_o[16:5]];
        end
    end
