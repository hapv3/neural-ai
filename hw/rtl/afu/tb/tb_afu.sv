...
module tb_afu;
    ...
    initial begin
        ...
        check_case("mode8_final_boundary_32",  MODE_8BIT,  'h100, 'h400, 32, 1);
        check_case("mode16_final_boundary_16", MODE_16BIT, 'h100, 'h500, 16, 2);
        check_case("mode32_final_boundary_8",  MODE_32BIT, 'h200, 'h600, 8,  3);
